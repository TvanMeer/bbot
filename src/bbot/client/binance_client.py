...
class _BinanceClient(_BaseClient):
    ...
    async def create_async_client(options: Options) -> AsyncClient:
    ...
    async def download_all_symbols(client: AsyncClient) -> List[Dict]:
    ...
    def parse_all_symbols(raw: List[Dict]) -> FrozenSet[str]:
    ...
    async def download_history(self, symbols: FrozenSet[str], client: AsyncClient, db: _Database) -> None:
    ...
    def to_timestring(interval: Interval, windowsize: int) -> str:
    ...
    def parse_historical_candle(self, raw: List, symbol: str, interval: Interval, db: _Database) -> None:
    ...
    async def start_candle_sockets(self, symbols: FrozenSet[str], client: AsyncClient, db: _Database) -> None:
    ...
    def parse_candle(self, raw: Dict) -> Candle:
        ...
        d = raw['data']['k']
        return Candle(event_time                   = self.ms_to_datetime(int(raw['data']['E'])),
                      symbol                       =                         raw['data']['s'],
    ...
    async def start_user_socket(client: AsyncClient) -> None:
